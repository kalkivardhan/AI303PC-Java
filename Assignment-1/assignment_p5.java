...
public class assignment_p5 {
    public static void main(String[] args) {
        ...
        LibraryItem book1 = new Book("Java", "B101");
        LibraryItem mag1 = new Magazine("bazzar", "M201");
        LibraryItem book2 = new Book("java txt boook", "B102");
        LibraryItem mag2 = new Magazine("Times new", "M202");
